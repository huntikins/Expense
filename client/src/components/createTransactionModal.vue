                  ...
                  <div class="form-group text-left">
                    ...
                    <div class="form-check my-2">
                      ...
                      <label
                        ...
                        for="defaultCheck1"
                      >Is this a recurring transaction?</label>
                    </div>
                    <label for="receiptUpload" class="my-2">Would you like to attatch a receipt?*</label>
                    <input type="file" class="form-control-file" id="receiptUpload" v-model="image">
...
export default {
  ...
  methods: {
    postTrans(event) {
      ...
      if (this.amount && parsedAmount.toString() !== this.amount)
        return (this.message = "Invalid dollar amount");
      if (
        this.amount &&
        this.amount.indexOf(".") > -1 &&
        this.amount.indexOf(".") < this.amount.length - 3
      )
        return (this.message = "Invalid dollar amount");
      axios
